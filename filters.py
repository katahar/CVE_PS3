...
# finalized_img_sharpened = sharpen(finalized_img_blurred,sharpen3x3ortho,1.5)
...
# test_img  = cv2.bilateralFilter(img,5,5,5)
# test_img2 = cv2.bilateralFilter(img,5,10,10)
# test_img3 = cv2.bilateralFilter(img,5,15,15)
